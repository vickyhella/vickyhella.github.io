...
- If the original page is migrated, find where the page is migrated and use the new URL in our docs.
- If the original page is deleted, or we cannot find where it's migrated, delete the link from our docs.
